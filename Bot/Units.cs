...
namespace Bot
{
    class Units
    {
        ...
        public static HashSet<uint> Production = new HashSet<uint>
            {
                ARMORY,
                BANELING_NEST,
                BARRACKS,
        ...
        public static HashSet<uint> ArmyUnits = new HashSet<uint>
            {
                ARCHON,
                AUTO_TURRET,
                BANELING,
        ...
        public static HashSet<uint> Workers = new HashSet<uint>
            {
                SCV,
                PROBE,
                DRONE
